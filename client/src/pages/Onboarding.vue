<template>
	<form class="mt-5">
		<input id="input-1" v-model="skills" type="text" placeholder="Mediterranean, Vegetarian, or Fast Food" required autofocus />
		<label for="input-1">
			<span class="label-text">Type of Food</span>
			<span class="nav-dot"></span>
		</label>
		<input id="input-2" v-model="interests" type="text" placeholder="Beautiful View, Romantic" required />
		<label for="input-2">
